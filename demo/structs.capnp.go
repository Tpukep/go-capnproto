...
Employment struct {
func (s PersonEmployment) SetUnemployed() { C.Struct(s).Set16(2, 0); }
Employer string
School string
func (s PersonEmployment) SetSelfEmployed() { C.Struct(s).Set16(2, 3); }
}
}
...
switch c {
case PHONENUMBERTYPE_MOBILE: return "mobile"
case PHONENUMBERTYPE_HOME: return "home"
case PHONENUMBERTYPE_WORK: return "work"
default: return ""
}
}
...
switch c {
case "mobile": return PHONENUMBERTYPE_MOBILE
case "home": return PHONENUMBERTYPE_HOME
case "work": return PHONENUMBERTYPE_WORK
default: return 0
}
}
